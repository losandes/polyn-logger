module.exports = {
  name: 'consoleStyles',
  dependencies: ['@polyn/blueprint', '@polyn/immutable'],
  factory: (polynBp, polynIm) => {
    'use strict'
    ...
    const ConsoleStylesOptions = immutable('ConsoleStylesOptions', {
      useColors: optional('boolean').withDefault(isTTY()),
    })

    function ConsoleStyles (input) {
      const { useColors } = new ConsoleStylesOptions(input)
